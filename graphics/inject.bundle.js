(() => {
    ...
    for (const styleSheet of element.ownerDocument.styleSheets) {
      try {
        for (const rule2 of (_a = styleSheet.rules) !== null && _a !== void 0 ? _a : []) {
          ...
          if (styleSheetHref) {
            const parsedSourceValue = (0, import_postcss_value_parser3.default)(rule2.style.getPropertyValue("src"));
            ...
            updatedFontFaceRule.walkDecls("src", (declaration) => {
              declaration.value = import_postcss_value_parser3.default.stringify(parsedSourceValue.nodes);
            });
  ...
  // inject.js
  window.elementToSVGString = (el) => new XMLSerializer().serializeToString(elementToSVG(el));
})();
